...
export default function WhyUs() {
  return (
    <section id="miert-minket" className="relative bg-anthracite py-24 md:py-32">
      <div className="container-page">
        <div className="grid lg:grid-cols-[0.9fr_1.1fr] gap-14 lg:gap-20 items-start">
          <div>
            <p className="eyebrow text-signal mb-4">Miért minket válasszon?</p>
            ...
            <p className="mt-5 text-steel-light text-lg leading-relaxed max-w-md">
          ...
          <div className="grid sm:grid-cols-2 gap-x-8 gap-y-10">
            {WHY_US.map((item, i) => {
              ...
              return (
                ...
                >
                  <div className="shrink-0 w-11 h-11 rounded-sm border border-signal/30 text-signal flex items-center justify-center">
                    <Icon size={20} strokeWidth={2} />
                  </div>
                  <div>
                    <h3 className="font-display font-semibold text-porcelain text-base">
                      {item.title}
                    </h3>
                    <p className="mt-1.5 text-sm text-steel-light leading-relaxed">
                      {item.description}
                    </p>
                  </div>
                </motion.div>
